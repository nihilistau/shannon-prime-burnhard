@echo off
REM compute-sanitizer memcheck on 35B with mmap loader, partial offload
set CUDA_LAUNCH_BLOCKING=1
set GGML_CUDA_DISABLE_GRAPHS=1
set SP_ENGINE_BACKEND=cuda
set SHANNON_PRIME_GPU_CACHE=0
"C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v13.2\bin\compute-sanitizer.bat" --tool=memcheck --launch-timeout=120 --target-processes=all --print-limit=20 ^
